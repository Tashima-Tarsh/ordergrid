...
must(render.includes('key: ORDERGRID_MANAGED_PARALLEL')&&render.includes('key: ORDERGRID_SESSION_CLAIM'),"render contract: free hosted worker must explicitly limit browser concurrency");
