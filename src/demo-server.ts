...
type Basket={id:string;tenant_id:string;batch_id:string;status:string;retailer:string;account_reference:string;customer_reference:string;recipient:string;city:string;postal_code:string;payment_route:string;batch_name:string;item_count:number;amount_minor:number;auth_status:string;failure_code?:string;failure_message?:string;execution_worker_id?:string;expires_at?:number;opened_at?:number;retailer_order_id?:string};
