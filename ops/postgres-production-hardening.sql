-- PostgreSQL production hardening for OrderGrid on AWS/RDS-compatible PostgreSQL.
-- Keeps audit history append-only for the restricted application role,
-- places extensions outside public, and ensures foreign-key lookup indexes exist.
