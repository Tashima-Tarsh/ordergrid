(()=>{
  ...
  style.textContent=`
    ...
    @media(max-width:900px){.flipkart-product-check{grid-template-columns:1fr 1fr}.product-check-result{grid-template-columns:1fr 1fr 1fr}.gst-product-grid{grid-template-columns:1fr 1fr 1fr}.gst-inclusive{align-self:end}}@media(max-width:600px){.flipkart-product-check,.product-check-result,.gst-product-grid{grid-template-columns:1fr}.wizard-summary-grid{grid-template-columns:1fr}.wide-summary{grid-column:auto}.steps{overflow:auto;justify-content:flex-start;gap:6px}.steps>*{white-space:nowrap}}
  `;
