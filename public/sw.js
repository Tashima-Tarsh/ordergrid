const CACHE='ordergrid-operations-v8';
const ASSETS=['./','./index.html','./styles.css','./finance.css','./premium.css','./dashboard.css','./app.js','./dashboard.js','./funding.js','./rewards.js','./checkout-fix.js','./autopilot.js','./assisted.js','./navigation.js','./manifest.webmanifest','./app-icon.svg'];
