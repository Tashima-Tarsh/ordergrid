...
import { checkoutHandoffUrl, retailerForProductUrl, validateRetailerOrderId } from "../src/assisted-checkout.js";
...
test("handoff removes fragments and validates retailer order IDs", () => {
  assert.equal(checkoutHandoffUrl("https://www.amazon.in/dp/B0TEST#reviews"), "https://www.amazon.in/dp/B0TEST");
